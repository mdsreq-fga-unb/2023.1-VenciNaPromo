...
<p align="justify"> &emsp;&emsp;
Após uma análise minuciosa, o grupo chegou à conclusão de que seria necessário fazer algumas alterações na composição dos MVPs. Durante nossas conversas, percebemos que algumas das histórias de usuário inicialmente planejadas não seriam viáveis de serem implementadas no MVP1. Percebemos que devido ao pouco conhecimento técnico da equipe, não seria possível entregar todas as funcionalidades dentro do prazo estabelecido.<br> &emsp;&emsp;
Diante dessa constatação, decidimos refazer a análise de viabilidade e complexidade técnica dos MVPs. Nesse processo, avaliamos cuidadosamente cada um dos requisitos e funcionalidades propostos.<br> &emsp;&emsp;
Abaixo estão as definições antigas dos MVPs, que foram revisadas e atualizadas de acordo com nossa nova compreensão das restrições técnicas e de prazo:</p>
...
| 19/06/2023 |   `1.3`   |  Atualização dos MVPs                    | Gabrielly        |
