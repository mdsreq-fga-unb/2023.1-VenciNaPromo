...
<p align="justify">
O objetivo principal do Venci na Promo pode ser descrito como: <br>
<li> Fornecer uma ferramenta que auxilie na resolução do problema do desperdício de alimentos próximos ao prazo de validade.</li>
...
<p align="justify">
Para Sommerville (2018), a escolha do processo de desenvolvimento de software pode ser facilitada através do esforço de responder uma série de perguntas sobre o sistema, o time de desenvolvimento e os stakeholders envolvidos, abarcando assim questões técnicas, humanas e organizacionais. A Figura 1 ilustra os pontos abordados pelas perguntas do método de Sommerville (2018). Listamos abaixo as perguntas propostas pelo método e as respostas para cada categoria.
</p><br>
