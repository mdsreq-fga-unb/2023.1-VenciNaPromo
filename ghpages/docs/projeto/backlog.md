...
| E3 |  US06    | Eu, como usuário-comprador, desejo visualizar a lista de itens que eu adicionei no meu carrinho de compras para que eu possa revisar meu pedido antes de finalizar a compra | 1. A lista de itens deve deve conter o nome, quantidade e preço. <br> 2. O carrinho de compras deve mostrar o valor total da compra. <br>4. Cada produto deve conter uma quantidade mínima de uma unidade. | 
...
| 31/05/2023 |   `2.1`   | Corrigindo critérios de aceitação                         | Gabrielly         |
